...
export default function ToolPage({ params }: Props) {
  // Since this is a client component, we can access params directly
  const id = params.id;
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <div className="bg-muted/10 border-b border-gray-900">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-6 mb-4">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  {tool.icon && (
                    <div className="rounded-md bg-[#6c5ce7]/10 p-3">
                      <Icon name={tool.icon} className="h-6 w-6 text-[#6c5ce7]" />
                    </div>
                  )}
                  <h1 className="text-3xl font-bold">{tool.name}</h1>
                </div>
                <p className="text-gray-400 max-w-3xl">{tool.description}</p>
              </div>
              
              <div className="flex-shrink-0 flex items-center gap-4 ml-auto">
                <Badge variant="outline" className="flex items-center gap-1 px-3 py-1 text-sm bg-gray-900">
                  <Video className="h-4 w-4" />
                  <span>{tool.videos.length} {tool.videos.length === 1 ? 'tutorial' : 'tutorials'}</span>
                </Badge>
                
                {currentVideo && (
                  <Badge variant="secondary" className="flex items-center gap-1 px-3 py-1 text-sm bg-gray-900">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-12">
            <div className="lg:col-span-2">
              {currentVideo ? (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 pt-2">
                      <Badge variant="outline" className="px-3 py-1.5 bg-black border-gray-800">
                ...
                <div className="flex aspect-video items-center justify-center rounded-lg border border-gray-800 bg-black">
                  <div className="text-center space-y-2">
                    <div className="rounded-full bg-gray-900 p-4 mx-auto">
            ...
            <div>
              <div className="sticky top-20">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Badge variant="outline" className="bg-black border-gray-800">
